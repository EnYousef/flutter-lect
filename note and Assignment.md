...
- *Extension methods*
  ...
  3. استخدم Extension methods لاضافة دالة جديدة تقوم بتحويل السلسة النصية الى رقم وفي حال لم تكون السلسة النصية تحوي على رقم قم بارجاع صفر.
